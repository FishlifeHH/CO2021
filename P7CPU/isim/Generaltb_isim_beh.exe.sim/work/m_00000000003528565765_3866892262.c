...
#endif
static const char *ng0 = "D:/VHDLfile/P7CPU/MDM.v";
static int ng1[] = {0, 0};
...
static unsigned int ng13[] = {3722304989U, 0U};
...
LAB52:    memcpy(t68, t31, 8);

LAB53:    memset(t96, 0, 8);
    t97 = (t68 + 4);
...
LAB84:    if (*((unsigned int *)t165) != 0)
        goto LAB85;

LAB86:    t172 = (t10 + 4);
    t173 = *((unsigned int *)t10);
    t174 = *((unsigned int *)t172);
    t175 = (t173 || t174);
    if (t175 > 0)
        goto LAB87;

LAB88:    t177 = *((unsigned int *)t10);
    t178 = (~(t177));
...
LAB90:    if (*((unsigned int *)t172) > 0)
        goto LAB91;

LAB92:    if (*((unsigned int *)t10) > 0)
        goto LAB93;

LAB94:    memcpy(t9, t181, 8);

LAB95:    t182 = (t0 + 5824);
    xsi_vlogvar_assign_value(t182, t9, 0, 0, 4);
    goto LAB29;
...
LAB38:    xsi_vlog_unsigned_bit_combine(t9, 4, t23, 4, t28, 4);
    goto LAB42;

LAB40:    memcpy(t9, t23, 8);
    goto LAB42;
...
LAB73:    *((unsigned int *)t113) = 1;

LAB75:    memset(t129, 0, 8);
    t130 = (t113 + 4);
...
LAB91:    xsi_vlog_unsigned_bit_combine(t9, 4, t176, 4, t181, 4);
    goto LAB95;

LAB93:    memcpy(t9, t176, 8);
    goto LAB95;
...
LAB20:    t63 = (t15 + 4);
    ...
    t66 = (~(t65));
    *((unsigned int *)t15) = t66;
    *((unsigned int *)t63) = 0;
    if (*((unsigned int *)t64) != 0)
        goto LAB22;

LAB21:    t71 = *((unsigned int *)t15);
    *((unsigned int *)t15) = (t71 & 1U);
...
LAB22:    t67 = *((unsigned int *)t15);
    t68 = *((unsigned int *)t64);
    *((unsigned int *)t15) = (t67 | t68);
...
LAB56:    memcpy(t233, t83, 8);

LAB57:    memset(t265, 0, 8);
    t266 = (t233 + 4);
...
LAB67:    memcpy(t130, t90, 8);

LAB68:    memset(t156, 0, 8);
    t157 = (t130 + 4);
...
LAB74:    if (*((unsigned int *)t123) != 0)
        goto LAB75;

LAB76:    t131 = *((unsigned int *)t90);
...
LAB77:    t142 = *((unsigned int *)t130);
    ...
    *((unsigned int *)t136) = (t154 & t152);
    t155 = *((unsigned int *)t136);
    *((unsigned int *)t136) = (t155 & t153);
    goto LAB79;

LAB80:    *((unsigned int *)t156) = 1;
    goto LAB83;
...
LAB88:    *((unsigned int *)t173) = 1;

LAB90:    memset(t189, 0, 8);
    t190 = (t173 + 4);
...
LAB92:    if (*((unsigned int *)t190) != 0)
        goto LAB93;

LAB94:    t198 = *((unsigned int *)t156);
...
LAB102:    t245 = *((unsigned int *)t233);
    t246 = *((unsigned int *)t239);
    *((unsigned int *)t233) = (t245 | t246);
    t247 = (t83 + 4);
    t248 = (t225 + 4);
    t249 = *((unsigned int *)t83);
    t250 = (~(t249));
...
LAB115:    xsi_set_current_line(92, ng0);
    ...
    t308 = *((char **)t307);
    t307 = (t0 + 5024);
    xsi_vlogvar_wait_assign_value(t307, t308, 0, 0, 32, 0LL);
...
LAB36:    xsi_vlog_unsigned_bit_combine(t3, 1, t106, 1, t111, 1);
    goto LAB40;

LAB38:    memcpy(t3, t106, 8);
    goto LAB40;

}


extern void work_m_00000000003528565765_3866892262_init()
{
	static char *pe[] = {(void *)Initial_49_0,(void *)Always_55_1,(void *)Always_70_2,(void *)Cont_112_3,(void *)Cont_113_4};
	xsi_register_didat("work_m_00000000003528565765_3866892262", "isim/Generaltb_isim_beh.exe.sim/work/m_00000000003528565765_3866892262.didat");
