...
#endif
static const char *ng0 = "D:/VHDLfile/P7CPU/AT_decoder.v";
...
LAB18:    xsi_vlog_unsigned_bit_combine(t3, 5, t74, 5, t79, 5);
    goto LAB22;
...
LAB24:    xsi_vlog_unsigned_bit_combine(t3, 5, t132, 5, t146, 5);
    goto LAB28;
...
LAB20:    t153 = (t0 + 8104);
    ...
    *((unsigned int *)t163) = (t165 | t159);
    xsi_driver_vfirst_trans(t153, 0, 4);
    t166 = (t0 + 7816);
    *((int *)t166) = 1;
...
LAB51:    memcpy(t124, t143, 8);

LAB52:    goto LAB34;

LAB35:    xsi_vlog_unsigned_bit_combine(t38, 5, t110, 5, t124, 5);
    goto LAB39;

LAB37:    memcpy(t38, t110, 8);
    goto LAB39;
...
LAB48:    xsi_vlog_unsigned_bit_combine(t124, 5, t138, 5, t143, 5);
    goto LAB52;

LAB50:    memcpy(t124, t138, 8);
    goto LAB52;
...
extern void work_m_00000000001859891920_3064659358_init()
{
	...
	xsi_register_didat("work_m_00000000001859891920_3064659358", "isim/Generaltb_isim_beh.exe.sim/work/m_00000000001859891920_3064659358.didat");
