...
#endif
static const char *ng0 = "D:/VHDLfile/P6CPU/MDM.v";
...
LAB72:    if (*((unsigned int *)t103) > 0)
        goto LAB73;

LAB74:    if (*((unsigned int *)t10) > 0)
        goto LAB75;

LAB76:    memcpy(t9, t112, 8);

LAB77:    t113 = (t0 + 5664);
    xsi_vlogvar_assign_value(t113, t9, 0, 0, 4);
    goto LAB29;
...
LAB73:    xsi_vlog_unsigned_bit_combine(t9, 4, t107, 4, t112, 4);
    goto LAB77;

LAB75:    memcpy(t9, t107, 8);
    goto LAB77;
...
LAB40:    memcpy(t164, t55, 8);

LAB41:    memset(t196, 0, 8);
    t197 = (t164 + 4);
...
LAB51:    memcpy(t128, t87, 8);

LAB52:    memset(t156, 0, 8);
    t157 = (t128 + 4);
...
LAB65:    if (*((unsigned int *)t157) != 0)
        goto LAB66;

LAB67:    t165 = *((unsigned int *)t55);
...
LAB81:    xsi_set_current_line(83, ng0);
    ...
    t239 = *((char **)t238);
    t238 = (t0 + 4864);
    xsi_vlogvar_wait_assign_value(t238, t239, 0, 0, 32, 0LL);
...
LAB32:    t106 = ((char*)((ng12)));
    goto LAB33;

LAB34:    t111 = ((char*)((ng14)));
    goto LAB35;

LAB36:    xsi_vlog_unsigned_bit_combine(t3, 32, t106, 32, t111, 32);
    goto LAB40;
...
extern void work_m_00000000003165531402_3866892262_init()
{
	static char *pe[] = {(void *)Always_46_0,(void *)Always_61_1,(void *)Cont_103_2,(void *)Cont_104_3};
	xsi_register_didat("work_m_00000000003165531402_3866892262", "isim/EX_isim_beh.exe.sim/work/m_00000000003165531402_3866892262.didat");
