...
#endif
static const char *ng0 = "D:/VHDLfile/P6CPU/forward_signal_generator.v";
static int ng1[] = {0, 0};
...
LAB81:    memcpy(t92, t113, 8);

LAB82:    t128 = (t0 + 4320);
    xsi_vlogvar_assign_value(t128, t92, 0, 0, 3);
    goto LAB69;
...
LAB94:    memcpy(t113, t127, 8);

LAB95:    goto LAB77;

LAB78:    xsi_vlog_unsigned_bit_combine(t92, 3, t104, 3, t113, 3);
    goto LAB82;

LAB80:    memcpy(t92, t104, 8);
    goto LAB82;

LAB83:    *((unsigned int *)t153) = 1;
    goto LAB86;
...
LAB91:    xsi_vlog_unsigned_bit_combine(t113, 3, t119, 3, t127, 3);
    goto LAB95;

LAB93:    memcpy(t113, t119, 8);
    goto LAB95;
...
LAB118:    xsi_set_current_line(51, ng0);
    t75 = ((char*)((ng6)));
    t93 = (t0 + 4320);
...
LAB43:    t137 = (t0 + 4640);
    xsi_vlogvar_assign_value(t137, t98, 0, 0, 3);
    goto LAB30;
...
LAB52:    xsi_vlog_unsigned_bit_combine(t117, 3, t131, 3, t136, 3);
    goto LAB56;

LAB54:    memcpy(t117, t131, 8);
    goto LAB56;
...
LAB73:    if (*((unsigned int *)t38) != 0)
        goto LAB74;

LAB75:    t61 = *((unsigned int *)t22);
    t62 = *((unsigned int *)t52);
    t63 = (t61 & t62);
    *((unsigned int *)t60) = t63;
    t53 = (t22 + 4);
...
extern void work_m_00000000003614338078_1152096529_init()
{
	...
	xsi_register_didat("work_m_00000000003614338078_1152096529", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000003614338078_1152096529.didat");
